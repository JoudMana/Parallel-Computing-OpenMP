...
// RETURNS the result variable (int**)
int** matrixMult(int** A, int** B, int n) {
    int** C = allocateMatrix(n);
    int** B_T = allocateMatrix(n);
